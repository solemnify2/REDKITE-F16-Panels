...
#define DEADZONE    500     // deadzone for systhetic brake and rudder 
#define NUMINPUT    45  
#define MAXPIN      55      // for Teensy 4.1
#define DELAY       5       // in miliseconds
...
void setup() {
  ...
  pinMode(A10, OUTPUT);        // Left Pedal
  pinMode(A11, OUTPUT);        // Right Pedal
